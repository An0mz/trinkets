...
public class TestTrinket extends TrinketItem implements TrinketRenderer {
	...
	public void render(ItemStack stack, SlotReference slotReference, EntityModel<?> contextModel, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, LivingEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
